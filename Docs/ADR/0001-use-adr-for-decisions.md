...
## Context
As the engine grows and multiple AI agents work on the codebase, we need a reliable way to communicate why specific technical choices were made. Without a history of decisions, agents may inadvertently reverse previous architectural choices or introduce inconsistencies.
...
## Consequences
- Better context retention across AI sessions.
